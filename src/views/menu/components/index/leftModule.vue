<template>
  <aside class="left">
    ...
    <menu class="index-menu">
      <h2>菜单</h2>
      <p @click="change" class="pList"><i class="click" index="00">全部</i></p>
      <p @click="change" class="pList"><i index="01">饮料</i></p>
      <p @click="change" class="pList"><i index="02">美食</i></p>
      <p @click="change" class="pList"><i index="03">咖啡产品</i></p>
      <p @click="change" class="pList"><i index="04">商品</i></p>
    </menu>
  </aside>
</template>
